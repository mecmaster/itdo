...
function sendPosEmail () {
	...
	var page = "http://www.sursly.com/ajaxContact/scripts/xmlHttpRequest.php?contact=true&xml=true";
...
function hideContactTimer () {
	...
	success.innerHTML = '<strong style="color:black;">'+grabPosXML("confirmation")+'</strong>';
